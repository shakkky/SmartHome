...
public final class ModelStringFilterInput implements InputType {
  ...
  ModelStringFilterInput(Input<String> ne, Input<String> eq, Input<String> le, Input<String> lt,
  ...
  public static final class Builder {
    ...
    public ModelStringFilterInput build() {
      return new ModelStringFilterInput(ne, eq, le, lt, ge, gt, contains, notContains, between, beginsWith);
    }
  }
}
