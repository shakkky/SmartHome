...
public final class CreateTodoMutation implements Mutation<CreateTodoMutation.Data, CreateTodoMutation.Data, CreateTodoMutation.Variables> {
  public static final String OPERATION_DEFINITION = "mutation CreateTodo($input: CreateTodoInput!) {\n"
  ...
  public CreateTodoMutation(@Nonnull CreateTodoInput input) {
    ...
    variables = new CreateTodoMutation.Variables(input);
  }

  @Override
  public String operationId() {
    return "0a5236f8c89bcef97a368b89c8eef5f6a83797d046cba9b7807f141ecf99c586";
  }
  ...
  public static final class Variables extends Operation.Variables {
    private final @Nonnull CreateTodoInput input;

    private final transient Map<String, Object> valueMap = new LinkedHashMap<>();

    Variables(@Nonnull CreateTodoInput input) {
      this.input = input;
      this.valueMap.put("input", input);
    }

    public @Nonnull CreateTodoInput input() {
      return input;
    }
  ...
  public static class Data implements Operation.Data {
    static final ResponseField[] $responseFields = {
      ResponseField.forObject("createTodo", "createTodo", new UnmodifiableMapBuilder<String, Object>(1)
    ...
    final @Nullable CreateTodo createTodo;
    ...
    public static final class Mapper implements ResponseFieldMapper<Data> {
      final CreateTodo.Mapper createTodoFieldMapper = new CreateTodo.Mapper();
  ...
  public static class CreateTodo {
    ...
    public CreateTodo(@Nonnull String __typename, @Nonnull String id, @Nonnull String name,
